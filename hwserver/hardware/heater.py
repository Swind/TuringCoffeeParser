...
import logging
logger = logging.getLogger("hwserver:heater")
...
def get_on_off_time(cycle_time, duty_cycle):
...
class Heater(object):
    ...
    def open(self):
        ...
        logger.info("Hardware Heater starting...")
        self.worker.start()
    ...
    def __manage_heat(self):
        while():
            ...
            on_time, off_time = get_on_off_time(cycle_time, duty_cycle)
